          ...
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/2 md:w-auto w-full px-4">
              <div className="flex py-3">
                <img className="h-14 w-14 rounded-xl " src= "https://media.istockphoto.com/vectors/needle-with-thread-vector-icon-sewing-concept-symbol-or-design-vector-id898233082?k=20&m=898233082&s=612x612&w=0&h=6gffKipltwm055qY0M5wZ_TmZJ_uqK3n7EyOjwh2wEY=" alt="" />
                <h2 className="title-font text-white tracking-widest text-md mt-5 font-bold px-4"> Embroidery </h2>
              </div>
              <p className="text-white text-md font-serif font-thin"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever.Since the 1500s, when an unknown printer. </p>
            </div>
            <div className="lg:w-1/3 md:w-auto w-full px-4 justify-center">
              <h2 className="title-font font-bold text-white tracking-widest text-md mb-3">More info</h2>
        ...
        {/* <div className="bg-gray-100">
          <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">
              © 2020 Tailblocks —
              <Link to="#" rel="noopener noreferrer" className="text-white ml-1" target="_blank">
                @knyttneve
              </Link>
            </p>
