...
const Footer = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="container px-5 md:py-20 py-5 mx-auto">
          <div className="flex flex-wrap items-between justify-between md:text-left order-first">
            <div className="lg:w-1/2 md:w-auto w-full px-4">
              <div className="flex py-3">
                <img
                  ...
                  alt=""
                />
                <h2 className="text-white text-md md:text-lg mt-5 md:mt-7 font-bold px-4"> Embroidery </h2>
              </div>
            ...
            <div className="lg:w-1/3 md:w-auto w-full px-4 justify-center">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <Link to="/design" className="text-white text-sm md:text-md">
                    Design
                  </Link>
                </li>
                <li>
                  <Link to="#" className="text-white text-sm md:text-md">
                    Privacy Policy
                  </Link>
                </li>
                <li>
