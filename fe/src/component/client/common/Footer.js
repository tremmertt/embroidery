          ...
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <a className="text-white hover:font-bold">Second Link</a>
                </li>
                <li>
                  <a className="text-white hover:font-bold">Third Link</a>
                </li>
                <li>
                  <a className="text-white hover:font-bold">Fourth Link</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
