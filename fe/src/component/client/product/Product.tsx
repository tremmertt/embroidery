    ...
    <div>
      {/* <section className="text-gray-600 body-font">
        <div className="container px-5 py-20 mx-auto">
          ...
          <div className="flex flex-wrap -m-4 pt-9">
            <div className="p-4 md:w-1/3">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h1 className="tracking-widest title-font text-lg font-medium text-gray-900 mb-3">
                    Embroidery Pattern 1
                  </h1>
                  ...
                  <div className="flex flex-row px-2 justify-center pt-3">
                    <p className="leading-relaxed font-semibold mb-3 text-left text-blue-500 mr-3">$289.43</p>
                    <p className="line-through text-gray-500 mr-3">$532.05</p>
                    <p className="text-red-500 tracking-widest text-md font-bold"> 24% OFF</p>
                  </div>
