...
from modules.django_mailbox.signals import message_received
from modules.django_mailbox.transports import Pop3Transport, ImapTransport, \
...
class Mailbox(models.Model):
    ...
    def get_connection(self):
        ...
        elif self.type == 'gmail' or self.type == 'smtps':
